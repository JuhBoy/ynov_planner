...
namespace events_planner.Migrations
{
    ...
    [Migration("20180407175225_UpdateNameOfTopsProperty")]
    partial class UpdateNameOfTopsProperty
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("events_planner.Models.Event", b =>
                {
                    b.HasOne("events_planner.Models.TopEvents", "TopEvents")
                        .WithOne("Event")
                        .HasForeignKey("events_planner.Models.Event", "TopEventsId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
